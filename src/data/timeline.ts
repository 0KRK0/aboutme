...
export const commits: Commit[] = [
  ...
  {
    id: 'pd1', lane: 'enterprise', t: 2024.5, when: 'Jul 2024',
    title: 'Salesforce Certified Platform Developer',
    body: 'First Salesforce certification (listed as Platform Developer I on the CV), earned a month before joining Accenture.',
    diff: ['Platform Developer'], more: 'credentials',
  },
  {
    id: 'sf-admin', lane: 'enterprise', t: 2025.25, when: 'Mar – Jun 2025',
    title: 'Salesforce Platform Administrator and Platform App Builder',
    body: 'Two more Salesforce certifications, covering administration (Mar 2025) and declarative app design (Jun 2025), alongside 13 Trailhead superbadges in Apex, flows and approval processes.',
    diff: ['Platform Administrator', 'Platform App Builder', '13 superbadges'], more: 'credentials',
  },
  {
